...
| [openai-image](./openai-image/) | 1.0.0 | OpenAI 이미지 생성/편집 (gpt-image-1.5 / gpt-image-1-mini, 마스크 편집, 투명 배경, prompt-rewriter 에이전트) | commands, skills, agents |

마켓플레이스 메타데이터: `.claude-plugin/marketplace.json` (현재 v1.4.0)
