...
# OpenAI Image Generation (gpt-image-1.5 / gpt-image-1-mini)
...
| `hq` | `gpt-image-1.5` | 최종 결과물, 조밀한 텍스트(로고·다이어그램), 복잡한 장면 |

원시 모델 ID(`--model gpt-image-1`, `--model gpt-image-2` 등)도 그대로 넘길 수 있다.
